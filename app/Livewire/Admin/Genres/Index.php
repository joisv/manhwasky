...
class Index extends Component
{
    ...
    {
        $query = Genre::search('name', $this->search)->orderBy($this->sortField, $this->sortDirection);
    ...
    {
        $val ? $this->mySelected = $this->getGenres()->limit($this->paginate)->pluck('id') : $this->mySelected = [];
    }
    ...
    {
        $query = $this->getGenres()->paginate($this->paginate);
