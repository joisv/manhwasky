    ...
    <div class="swiper-wrapper">
        @forelse ($sliders as $slider)
            <div class="swiper-slide flex items-center ">
                <div class="w-[90%] h-[37%] sm:h-[60%] mx-auto flex justify-between items-end bg-cover">
                    ...
                    <div
                        ...
                        <article class="w-1/2 absolute sm:right-4">
                            ...
                            <p class="text-gray-100 font-medium text-lg hidden sm:flex"
                                x-text="sliceStr('{{ $slider->series->overview }}', 250)"></p>
                            {{-- <p class="text-gray-100 font-medium text-sm sm:hidden flex"
                                x-text="sliceStr('{{ $slider->series->overview }}', 50)"></p> --}}
