<div class="min-h-screen max-w-5xl mx-auto space-y-4">
    <div class="sm:grid grid-cols-4 items-center">
        <div class="w-full h-72 col-span-2 overflow-hidden">
            <img src="{{ asset('storage/' . $series->gallery->image) }}" alt="" class="object-cover w-full h-full object-top">
        </div>
        <div class="flex justify-between w-full col-span-2  p-2 font-comicBold h-fit">
            <div class="w-full">
                ...
                <div class="mt-8">
                    <a href="{{ route('chapter', [$series->title, $series->chapters()->first()->slug]) }}" wire:navigate>
                ...
                <div class="flex space-x-3 items-center">
                    @forelse ($series->chapters as $chapter)
                        <div class="w-36 sm:h-40 h-36 relative overflow-hidden">
                            <img src="{{ $chapter->contents()->first()->url }}" alt="" class="object-fill absolute bottom-0">
                        </div>
