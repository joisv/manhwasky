<div x-data="{
    ...
    toggleSetting(){
        this.seriesSetting.classList.toggle('translate-x-full')
        console.log(this.seriesSetting)
    }
}" x-init="tagSearchResult = dataTag" class="relative">
    <form wire:submit="save">
        <x-primary-button type="submit">save</x-primary-button>
        <button type="button" class="absolute -top-16 -right-5 lg:hidden flex" @click="toggleSetting"><svg width="20px" height="20px" viewBox="0 0 24 24" fill="none"
        ...
        <div class="flex w-full space-x-2">
            ...
            {{-- Setting series --}}
            <div id="series_setting" class="fixed translate-x-full lg:translate-x-0 right-0 lg:w-[24vw] xl:w-[23vw] bg-white p-5 rounded-sm top-20 h-[85vh] space-y-4 overflow-y-auto ease-in duration-100">
                <div class="flex items-center space-x-2">
                    <button type="button" class="z-50 lg:hidden flex" @click="toggleSetting"><svg width="20px" height="20px" viewBox="0 0 24 24" fill="none"
                        class="ease-in duration-200"
                        xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                ...
                {{-- Date picker --}}
                <livewire:admin.series.set-date :value="$date" />
                {{-- Permalink --}}
